<template>
  <div class="all">
    <el-row class="header">
      <dv-decoration6 style="width:12vmax;height:3vh;" />
    ...
    <el-row class="mid">
      <div class="startAndpause">
        <img v-if="isStarted" :src="pause" @click="pauseWar()">
        <img v-else :src="bofang" @click="pauseWar()">
      </div>


      <dv-decoration5 :dur="2" style="width:12vmax;height:2vh;" />
    </el-row>
    <el-row class="main">
      <el-col :span="12" style="height: 100%;bottom:0vh">
        <dv-border-box1 style="width:50vmax;height:18vh">
        ...
        <dv-border-box11 title="战役过程一览" :title-width="400" style="height: 80%;width:50%;bottom:0px;position: absolute;">
          <div class="mapOutCon">
          ...
          <el-col :span="12" style="height: 100%;">
            <dv-border-box1 :reverse="true">
              <div class="BingliCon">
                ...
                <!-- <div id="bingli"></div> -->
                <!-- 战争解读视频 -->
                <div style="width:100%;height: 100%;display: flex;justify-content: center;margin-top:2vh">
                  <vue3VideoPlay width="22vmax" height="30vh" title="钢铁侠" :src="options.src" :poster="options.poster"
